...
class RequestJsonParserTest {
    ...
    @Test
    void parsePaymentRequest_shouldThrowValidationException_whenAgreementIdAndAgreementPaymentTypeIsProvidedAndAuthorisationModeIsNotSpecified() throws Exception {
        // language=JSON
        String payload = """
                {
                   "amount": 1000,
